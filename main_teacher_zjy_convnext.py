...
from engine_teacher import train_one_epoch, evaluate, test
...
import utils
import random
from convnext_model import convnext_small
...
def main(args):
    ...
    #model.load_state_dict(torch.load('regnetx_004-7d0e9424.pth'))
    ...
    model = CustomClassifier(model, 768, args.nb_classes, multi_dataset_classes=multi_dataset_classes, known_data_source=args.known_data_source)
    #print(args.nb_classes)
    model.to(device)
