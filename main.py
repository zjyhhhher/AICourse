...
from dataset_A import build_dataset, GroupedDataset
...
def get_args_parser():
    ...
    #parser.add_argument('--known_data_source', action='store_false', dest='known_data_source', default=False)
    #parser.add_argument('--unknown_data_source', action='store_true', dest='known_data_source', default=True)
    parser.add_argument('--known_data_source', action='store_true', dest='known_data_source', default=False)
